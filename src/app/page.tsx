...
import { MessageSquare, BarChart3, ArrowRight, Map, FileSearch, Film } from 'lucide-react'
...
const features = [
  ...
  },
  {
    ...
    icon: Film,
    title: 'Videos',
    description: 'Marketing and investor promo videos for regional hubs and site presentations',
