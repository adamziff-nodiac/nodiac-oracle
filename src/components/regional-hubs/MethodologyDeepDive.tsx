  ...
  return (
    <div className="border border-gray-200 dark:border-white/10 rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
      >
      ...
      <div className="space-y-3">
        ...
        <Collapsible title="How the Composite Score Works" defaultOpen>
          ...
          <p>
            ...
            using <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">useMemo</code>. Moving a slider
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2">
                ...
                county level. The <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded text-xs">Service_Territory_2024.xlsx</code> file
                maps 2,907 utilities to counties (11,776 rows). The <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded text-xs">Frame_2024.xlsx</code> file
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                (<code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">permitting-sentiment</code>)
        ...
        <Collapsible title="Normalization (How Raw Data Becomes 0-1 Scores)">
          ...
          <p>
            ...
            <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">1 &minus; rank</code> so that
          ...
          <p>
            Curtailment uses <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">log1p(MW)</code>{' '}
          ...
          <div className="space-y-2 mt-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">&mdash; #2d2233 (muted purple, visible against dark base map)</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">&mdash; #5c2d55 (mid purple)</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">&mdash; #8b3578 (bright Nodiac purple)</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">&mdash; #b48fc1 (soft orchid, peak desirability)</span>
              </div>
            </div>
          </div>
          <p className="mt-3">
        ...
        <Collapsible title="Data Pipeline and Current Status">
          <p>
            The data pipeline (<code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">scripts/build-real-county-scores.py</code>)
            downloads and processes public datasets from federal agencies to compute per-county scores.
            Run with <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">uv run scripts/build-real-county-scores.py</code>.
          </p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm mt-2">
              <thead>
                <tr className="border-b border-gray-200 dark:border-white/10">
                  <th className="text-left py-2 pr-3 text-gray-500 dark:text-gray-400 font-medium">Criterion</th>
                  <th className="text-left py-2 pr-3 text-gray-500 dark:text-gray-400 font-medium">Source</th>
                  <th className="text-left py-2 pr-3 text-gray-500 dark:text-gray-400 font-medium">Coverage</th>
        ...
        <Collapsible title="County Boundaries and FIPS Codes">
          <p>
            ...
            <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">FIPS</code> property &mdash;
          ...
          <p>
            ...
            <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">interpolate</code> expression
            per-feature to determine the fill color. This avoids the Mapbox style expression size limit
            (~3,000 entries in a{' '}
            <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">match</code> expression)
        ...
        <Collapsible title="Known Limitations and Caveats">
          <ul className="list-disc list-inside space-y-2 ml-2">
            ...
            <li>
              ...
              versions will track <code className="text-nodiac-secondary bg-gray-100 dark:bg-white/5 px-1 rounded">last_permitting_update</code> timestamps.
            </li>
          </ul>
        </Collapsible>
      </div>
