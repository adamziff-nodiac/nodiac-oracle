      ...
      >
        {!isUser && perspective && (
          <button
            ...
            className="flex items-center gap-1.5 mb-1.5 text-xs text-gray-500 hover:text-gray-700 transition-colors w-full"
          >
            {isCollapsed ? (
        ...
        {isCollapsed ? (
          ...
          <div className={cn(
            ...
            '[&_table]:border-collapse [&_th]:border [&_th]:border-gray-300 [&_th]:px-2 [&_th]:py-1 [&_th]:bg-gray-200',
