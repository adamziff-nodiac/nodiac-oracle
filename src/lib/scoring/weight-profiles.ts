...
export const WEIGHT_PROFILES: WeightProfile[] = [
  {
    id: 'balanced',
    name: 'Balanced',
    description: 'Equal weight across all eight criteria',
    weights: {
      coop_density: 1,
      grid_reliability: 1,
      clipped_curtailed: 1,
  ...
  },
  {
    id: 'hyperscaler',
    name: 'Hyperscaler',
    description: 'Weights aligned with hyperscaler site evaluation priorities (power, permitting, fiber, labor)',
    weights: {
      coop_density: 0.5,
      grid_reliability: 3,
      clipped_curtailed: 1,
